    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            if (b == "2d")
            {
                ...
                var (re, time) = snesim.simulate_multigrid(1001, 3, 10, (8, 8, 0), TI, cd, re_gs, ratio_inverseRetrieve);
            ...
            if (b == "3d")
            {
                ...
                //6. Run FastSnesim Simulation
                Snesim snesim = Snesim.create();
                var (re, time) = snesim.simulate_multigrid(1001, 1, 80, (7, 7, 3), TI, cd, re_gs, ratio_inverseRetrieve);
