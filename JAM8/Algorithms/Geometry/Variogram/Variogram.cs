...
namespace JAM8.Algorithms.Geometry
{
    ...
    public class Variogram
    {
        ...
        /// <returns></returns>
        public static (double[] h, double[] gamma, int[] N_pair) calc_experiment_variogram(GridProperty gp,
        ...
        /// <param name="lag_unit"></param>
        /// <returns></returns>
        public static (double[] h, double[] gamma, int[] N_pair) calc_3d_horizontal_experiment_variogram(
        ...
        /// <param name="lag_unit"></param>
        /// <returns></returns>
        public static (double[] h, double[] gamma, int[] N_pair) calc_3d_vertical_experiment_variogram(GridProperty gp,
