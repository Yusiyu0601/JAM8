    ...
    public class STree
    {
        ...
        private void init_tree()
        {
            ...
            foreach (var (_, pattern) in patterns)
            {
                ...
                STreeNode temp_node = root.children[(int)pattern[0].Value];
        ...
        /// <returns></returns>
        public Dictionary<int, int> retrieve(MouldInstance data_event, int cd_min)
        {
        ...
        /// <param name="cd_min"></param>
        /// <returns></returns>
        public Dictionary<int, int> retrieve_inverse(MouldInstance data_event, int cd_min)
        {
        ...
        /// <param name="cd_min"></param>
        /// <returns></returns>
        public Dictionary<int, int> retrieve_recursive(MouldInstance data_event, int cd_min)
        {
            List<Dictionary<int, int>> core_values_all_levels = [];

            // 递归辅助函数
            Dictionary<int, int> Traverse(List<STreeNode> nodes, int neighbor_idx)
            {
